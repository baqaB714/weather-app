            ...
            <div className='w-full px-2'>
                <form>
                    <div class="relative">
                        ...
                        <input type="search" id="search" class="block w-full p-4 ps-10 text-lg text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="نام شهر یا کشور" required />
