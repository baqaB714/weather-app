                ...
                <div>
                    <div className="relative">
                        ...
                        <input
                            ...
                            type="search"
                            id="search"
                            className="block w-full p-4 ps-10 text-lg text-gray-900 border rounded-lg "
                            placeholder="نام شهر یا کشور" required />
                        <button onClick={handleGetWeather} type="submit" className="text-white absolute end-2.5 bottom-3 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 ">جست و جو</button>
                    </div>
                </div>
            </div>
        </div>
